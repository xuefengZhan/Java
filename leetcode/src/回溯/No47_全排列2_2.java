...
public class No47_全排列2_2 {

    List<List<Integer>> res = new ArrayList<>();

    public List<List<Integer>> permuteUnique(int[] nums) {
        Arrays.sort(nums);
        place(new ArrayList<Integer>(),nums,0,new byte[nums.length]);
    ...
    private void place(List<Integer> path,int[] nums,int start,byte[] usedIndex){
